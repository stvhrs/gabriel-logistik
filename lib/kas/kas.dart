      ...
      (index, element) => Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
                flex: 7,
                child: Text(Rupiah.format(element.totalOngkos).toString(),
                    style: Theme.of(context).textTheme.displaySmall)),
            Expanded(
                flex: 7,
                child: Text(Rupiah.format(element.totalKeluar).toString(),
                    style: Theme.of(context).textTheme.displaySmall)),
            Expanded(
                flex: 7,
                child: Text(Rupiah.format(element.totalSisa).toString(),
                    style: Theme.of(context).textTheme.displaySmall)),
            Expanded(
                flex: 7,
